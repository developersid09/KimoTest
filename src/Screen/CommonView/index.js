...
const CommonView = ({ route, navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.loginHeader}>
        ...
        <View style={styles.emptyHeader}>
          <Text style={styles.headerText}>{route.params?.screenName}</Text>
        </View>
              ...
              <View style={styles.grayBox}>
                <View style={{
                  ...
                  <View style={{
                    ...
                    <Text style={styles.boxText3}>{ele.title}</Text>
                  </View>
                </View>
                ...
                {ele?.data.map((item) => {
                  return (
                    <View style={styles.touchView}>
                      <Text style={styles.boxText4}>{item}</Text>
                    </View>
                  )
                })
                }
